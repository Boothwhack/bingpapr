...
impl Hyprpaper {
    ...
    fn send(&self, msg: &[u8]) -> Result<String, io::Error> {
    ...
    pub fn preload(&self, path: &Path) -> Result<String, io::Error> {
    ...
    pub fn set_wallpaper(&self, monitor: &str, path: &Path) -> Result<String, io::Error> {
